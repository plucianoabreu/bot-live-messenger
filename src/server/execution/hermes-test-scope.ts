...
export function permitsHermesAdmission(env: Record<string, string | undefined>, userId: string) {
  if (env.HERMES_ENABLED !== 'true' && env.PREWARM_ENABLED !== 'true') return true;
  return isHermesTestUserAllowed(env, userId);
}
